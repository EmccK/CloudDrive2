...
```shell
curl -fsSL "https://gh-proxy.com/https://raw.githubusercontent.com/emcck/clouddrive2/main/cd2.sh" | bash -s install
```

### 卸载命令
```shell
curl -fsSL "https://gh-proxy.com/https://raw.githubusercontent.com/emcck/clouddrive2/main/cd2.sh" | bash -s uninstall
```
...
### 安装 (未ROOT设备)
```shell
curl -fsSL "https://gh-proxy.com/https://raw.githubusercontent.com/emcck/clouddrive2/main/cd2-termux.sh" | bash -s install
```

### 安装 (已ROOT设备)
```shell
curl -fsSL "https://gh-proxy.com/https://raw.githubusercontent.com/emcck/clouddrive2/main/cd2-termux.sh" | bash -s install root
```

### 卸载
```shell
curl -fsSL "https://gh-proxy.com/https://raw.githubusercontent.com/emcck/clouddrive2/main/cd2-termux.sh" | bash -s uninstall
```
